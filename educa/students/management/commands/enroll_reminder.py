...
class Command(BaseCommand):
    help = ('Sens an e-mail reminder to users registered'
            ' more than N days that are not enrolled into any courses yet')
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            message = """
            Dear {}, We noriced the you didn't enroll in any courses yet.
            We are you waititng for?
